...
FitTracker/
├── Views/
│   ├── TodayView.swift        # Main Dashboard with ML Insights
│   ├── ExerciseDetailView.swift # Logging screen with Smart Autofill
│   ├── SessionDetailView.swift  # Workout summary & Music Journal
│   ├── WorkoutMapView.swift   # MapKit integration
│   └── ...
├── Managers/
│   ├── RecompManager.swift    # Linear Regression & Coaching Logic
│   ├── DataManager.swift      # JSON Persistence
│   ├── HealthManager.swift    # HealthKit Sync
│   ├── MusicManager.swift     # Audio Control & Permissions
│   └── ...
└── Models/
    └── WorkoutModels.swift    # Data Structures (Codable)
